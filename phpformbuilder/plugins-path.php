...
if (in_array($_SERVER['REMOTE_ADDR'], $localhost)) { // PATH FOR LOCALHOST'S PLUGINS DIR, REPLACE WITH YOUR OWN.
    ...
    define('PLUGINS_DIR', 'http://phpformbuilder.creation-site.org/phpformbuilder/plugins/');
}
 ...
 * ex : http://phpformbuilder.creation-site.org/plugins/ => /phpformbuilder/plugins/
